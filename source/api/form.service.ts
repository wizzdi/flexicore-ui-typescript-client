...
export class FormService {
    ...
    public createForm(body?: FormCreate, authenticationKey?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.post<Form>(`${this.basePath}/plugins/Forms/createForm`,
            body,
            {
    ...
    public copyForm(body?: FormCopy, authenticationKey?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.post<Form>(`${this.basePath}/plugins/Forms/copyForm`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getAllForms(body?: FormFiltering, authenticationKey?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.post<PaginationResponse<Form>>(`${this.basePath}/plugins/Forms/getAllForms`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public updateForm(body?: FormUpdate, authenticationKey?: string, observe: any = 'body', reportProgress: boolean = false): Observable<any> {
        ...
        return this.httpClient.put<Form>(`${this.basePath}/plugins/Forms/updateForm`,
            body,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
