...
let ConfigurationPresetsService = class ConfigurationPresetsService {
    ...
    createConfigurationPreset(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/ConfigurationPresets/createConfigurationPreset`, body, {
    ...
    getAllConfigurationPresets(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.post(`${this.basePath}/plugins/ConfigurationPresets/getAllConfigurationPresets`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
    ...
    updateConfigurationPreset(body, authenticationKey, observe = 'body', reportProgress = false) {
        ...
        return this.httpClient.put(`${this.basePath}/plugins/ConfigurationPresets/updateConfigurationPreset`, body, {
            withCredentials: this.configuration.withCredentials,
            headers: headers,
            observe: observe,
            reportProgress: reportProgress
